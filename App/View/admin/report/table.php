  ...
  <main class="dashboard">
    <div class="dashboard__container">
      ...
      <div class="dashboard__container__top">
        <h1 class="dashboard__title ">Rapport sur les animaux</h1>
        <?php if (Security::isVeterinary()) { ?>
          <a class=" max-width--mobile" href="rapport-animaux/add">
              ...
              foreach ($data['reportAnimals'] as $reportAnimal) : ?>
                <tr>
                  <td class="hidden--mobile">
                    <?= $reportAnimal['email'] ?? 'utilisateur supprimé' ?>
                  </td>
                  <td>
                    <?= $reportAnimal['name'] ?>
                  </td>
                  ...
                  <td class="hidden--mobile">
                    <?= $reportAnimal['habitat'] ?? 'aucun habitat' ?>
                  </td>
                  <td class="hidden--mobile">
                    <?= $reportAnimal['food'] ?>
                  </td>
