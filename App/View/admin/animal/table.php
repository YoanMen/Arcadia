  ...
  <main class="dashboard">
    <div class="dashboard__container">
      ...
      <div class="dashboard__content">
        <table aria-describedby="animal table">
          <thead>
            <tr>
              <th>
                ...
                <tr>
                  ...
                  <td>
                    <a href=" animaux/<?= $animal->getId() ?>/edit">
                      <img height="32px" src="/assets/images/icons/pencil.svg" alt="edit icon">
                    </a>
                  </td>
                  <td>
                    <form id="deleteForm" method="POST" action="animaux/<?= $animal->getId() ?>/delete">
                      ...
                      <button class="dashboard__params delete-js" type="submit">
                        <img height=" 32px" src="/assets/images/icons/delete.svg" alt="delete icon">
                      </button>
                    </form>
                  </td>
                </tr>
